...
## Warna kecil itu digunakan untuk tulisan kecil, ia mestilah lebih terang/gelap
...
## Jika ditetapkan kepada True, latar belakang imej akan dijubinkan. Jika False,
## latar belakang imej akan disesuaikan saiznya secara linear.
...
## Kedudukan, lebar, dan penjajaran label yang memberikan nama kepada watak yang
## sedang bercakap.
...
## Jumlah entri mod NVL maksimum yang Ren'Py akan paparkan. Apabila lebih banyak
## entri akan ditunjukkan, entri paling lama akan dibuang.
...
## Kedudukan, lebar, dan penjajaran tulisan nvl_thought (tulisan yang dicakapkan
## oleh watak nvl_narrator).
...
## Ini mengawal di mana baris pemisah dibenarkan. Lalainya ia sesuai untuk semua
## bahasa. Senarai nilai yang ada boleh dijumpai di https://www.renpy.org/doc/
## html/style_properties.html#style-property-language
