...
## Tulisan yang diletakkan pada skrin perihalan permainan. Letakkan tulisan
## di antara tanda petikan ganda tiga, dan biarkan baris kosong di antara
## perenggan.
...
## Untuk membolehkan pengguna memainkan bunyi percubaan untuk saluran bunyi atau
## suara, nyahkomen satu baris di bawah dan gunakannya untuk menetapkan bunyi
## sampel untuk dimainkan.
...
define config.save_directory = "placeholder-1740318223"
...
## Nama pengguna dan nama projek yang dikaitkan dengan projek itch.io,
## dipisahkan dengan tanda palang sendeng (/).
